...
export function Portfolio() {
  ...
  const projects = [
    ...
    {
      nameKey: "portfolio.health",
      descriptionKey: "portfolio.health.description",
      image: "/images/projects/ice-health.jpg",
      tags: ["Flutter", "WebRTC", "PostgreSQL"],
      gradient: "from-[#00BFA5] to-[#0D3B38]",
    },
    {
      nameKey: "portfolio.finance",
      descriptionKey: "portfolio.finance.description",
