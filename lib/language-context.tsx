...
"services.cloud.title": "Networking & Cloud Infrastructure",
"services.cloud.description": "Secure networking and cloud infrastructure solutions—from servers and deployments to networking setup, hosting, and scalable cloud environments built for your business.",    "services.ai.title": "AI & Machine Learning",
...
"services.cloud.title": "الشبكات والبنية التحتية السحابية",
"services.cloud.description": "حلول متكاملة للشبكات والبنية التحتية السحابية تشمل إعداد الخوادم والشبكات والاستضافة والنشر وبناء بيئات سحابية آمنة وقابلة للتوسع تناسب احتياجات عملك.",    "services.ai.title": "الذكاء الاصطناعي",
...
"products.platform.name": "ICE Suite",
"products.platform.description": "نأخذ عملك من الفكرة إلى واقع رقمي متكامل—بدءًا من بناء الهوية التجارية، وتجهيز البنية التقنية، وصولًا إلى تطوير حلول برمجية مخصصة تدعم عملياتك الداخلية والخارجية.",
